...
class MathAnalyzer(object):
	...
	def analyze(self):
		...
		if num_error > 0:
			verdict = 'Compressed data'
		else:
			verdict = 'High entropy data'
...
#	print "   <td>%d</td>" % num_error
#	print "   <td>%d</td>" % largest[1]
#	print "   <td>%d</td>" % largest[0]
#	print "   <td>%d</td>" % len(data)
